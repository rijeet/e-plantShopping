...
Welcome to Paradise Nursery Shopping Application, where nature meets tranquility! This project is a small e-commerce website built using React as part of my learning journey in Full-Stack Development with IBM. The website is now live on GitHub Pages and showcases a variety of plants that can be purchased online.

## 🚀 Live Demo

Check out the live demo of the website [here](https://rijeet.github.io/e-plantShopping).
